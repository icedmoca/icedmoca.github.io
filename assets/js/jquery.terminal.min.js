...
(function(e) {
    var p = function() {
        if (!p.cache.hasOwnProperty(arguments[0])) {
            p.cache[arguments[0]] = p.parse(arguments[0])
        }
        return p.format.call(null, p.cache[arguments[0]], arguments)
    };
        ...
        for (o = 0; o < r; o++) {
            ...
            if (i === "string") {
                ...
                if (l[2]) {
                    ...
                    for (s = 0; s < l[2].length; s++) {
                        if (!u.hasOwnProperty(l[2][s])) {
                            throw p('[sprintf] property "%s" does not exist', l[2][s])
                        }
                        u = u[l[2][s]]
                    }
                } else if (l[1]) {
                ...
                if (/[^s]/.test(l[8]) && m(u) !== "number") {
                    throw p("[sprintf] expecting number but found %s", m(u))
                }
                switch (l[8]) {
                    case "b":
                        u = u.toString(2);
...
(function(r, i) {
            ...
            timer: {
                ...
                add: function(e, t, n, r, i, u) {
                    ...
                    if (!e.$timers[n][r.$timerID]) {
                        e.$timers[n][r.$timerID] = window.setInterval(o, t)
                    }
                    if (!this.global[n]) {
                        this.global[n] = []
                    }
    ...
    $.fn.cmd = function(e) {
        ...
        for (M = 65; M < 91; M++) {
            ...
            N[M] = [H.toLowerCase(), H.toUpperCase()]
        }
        var U = {};
        ...
        var q = {
            ...
            ENTER: function() {
                if (_ && S && !x.mask && (is_function(x.historyFilter) && x.historyFilter(S) || x.historyFilter instanceof RegExp && S.match(x.historyFilter) || !x.historyFilter)) {
                    _.append(S)
                }
                var e = S;
                B.$node.blur();
            ...
            ARROWRIGHT: ae,
            "HOLD+ARROWRIGHT": debounce(ae, 10),
            "CTRL+F": ae,
        ...
        function fe() {
            if (animation_supported) {
                var e = window.getComputedStyle(L[0]);
        ...
        if (animation_supported && !is_android) {
            C = function(e) {
                if (e) {
                    L.addClass("cmd-blink")
                } else {
                    L.removeClass("cmd-blink")
                }
            };
            O = function() {
                var e = L.clone();
            ...
            C = function(e) {
                if (e && !De) {
                    De = true;
                    L.addClass("cmd-inverted cmd-blink");
                    k.everyTime(500, "blink", pe)
                } else if (De && !e) {
                    De = false;
                    k.stopTime("blink", pe);
                    L.removeClass("cmd-inverted cmd-blink")
                }
            };
            O = function() {
                C(false);
        ...
        function pe() {
            L.toggleClass("cmd-inverted")
        }

        function me() {
            h = "(reverse-i-search)`" + f + "': ";
            Se()
        }
        ...
        var Ce = new WorkerCache({
            validation: function(e) {
                var t = false;
                if ((!this._previous_value || this._previous_value === e) && (!this._cols || this._cols === D)) {
                    t = true
                }
        ...
        function xe(e) {
            return strlen(text(e)) > D - p - 1 || e.match(/\n/)
        }
        ...
        var Ae = function() {
            ...
            function y(e, t) {
                ...
                L.toggleClass("cmd-end-line", r);
                fe();
                var D = $.terminal.length(L.text());
                if (D > 1) {
                    var p = L.find("[data-text]")[0];
            ...
            function F() {
                L.html('<span data-text class="end"><span>&nbsp;<span></span>')
            }
            ...
            return function() {
                ...
                var v = C.prevUntil(".cmd-prompt").length;
        ...
        var Se = function() {
            function t(e) {
                ...
                e = crlf(e);
                s = e;
                var t = $.terminal.split_equal(e, D).map(function(e) {
                ...
                var u = t.slice(0, -1).map(function(e) {
                    e = $.terminal.encode(e, {
                        tabs: x.tabs
                    });
        ...
        $.extend(k, {
            ...
            name: function(e) {
                if (e !== undefined) {
                    g = e;
                    var t = _ && _.enabled() || !_;
                    _ = new History(g, x.historySize, x.history === "memory");
                    if (!t) {
                        _.disable()
                    }
                    return k
            ...
            destroy: function() {
                tt.unbind("keypress.cmd", nt);
                tt.unbind("keydown.cmd", Ze);
                tt.unbind("input.cmd", ut);
                k.stopTime("blink", pe);
            ...
            display_position: function(e, t) {
                if (e === undefined) {
                    ...
                    var n = be($.terminal.escape_formatting(S), true);
                    var r = Ee(n);
                    var i = bare_text(S).length;
                    var u;
                    if (t) {
        ...
        function Ze(e) {
            ...
            var t;
            He = (e.key || "").toLowerCase() === "process" || e.which === 0;
            Oe = ze && Pe && !Qe(e);
            try {
                if (!e.fake) {
                    Pe = Ye(e);
                    Ie = String(e.key).toLowerCase() === "unidentified";
                    Me = Qe(e)
                }
            } catch (e) {}
            ...
            if (v || n === "CTRL+C" && is_terminal_selected(k)) {
                if (Ue) {
                    Je = n;
                    n = "HOLD+" + n;
                    if (We) {
        ...
        var tt = $(document.documentElement || window);
        k.keymap(x.keymap || {});
        ...
        function nt(e) {
            ...
            if (v) {
                ...
                if ($.inArray(e.which, [13, 0, 8]) > -1) {
                    ...
                    return false
                } else if (n && (!e.ctrlKey || e.ctrlKey && e.ctrlKey) && (!(e.altKey && e.which === 100) || e.altKey) && !Oe) {
                    if (l) {
                        f += n;
                        he();
                        me()
        ...
        function ut() {
            debug("input " + Ne + " || " + He + " ((" + ze + " || " + Oe + ") && !" + qe + " && (" + Pe + " || " + Ie + ") && !" + Me + ")");
            var e = B.val();
            if (!is_mobile) {
                e = e.replace(/^ /, "")
            }
            if ((Ne || He || (ze || Oe) && !qe && (Pe || Ie) && !Me) && e !== S) {
                var t = R;
                if (Ne) {
                    var n = Ke;
                    Me = n.slice(0, n.length - 1).length === e.length
                }
                if (it) {
                    it = false;
                    B.val(S);
                ...
                if (l) {
                    ...
                    if (r.length === 1 || Me) {
                        ...
                        if (Ne) {
                            ...
                            rt("keydown", Me ? "Backspace" : r, u)
                        }
                        if (ze && !Me) {
                            rt("keypress", i, r.charCodeAt(0))
                        }
                    }
                    if (Me) {
                        Ke = S;
                ...
                if (Me) {
                    ...
                    k.position(t + Math.abs(e.length - Ke.length))
                }
            }
            Ke = S;
            qe = false;
        ...
        tt.bind("keypress.cmd", nt);
        tt.bind("keydown.cmd", Ze);
        tt.bind("keyup.cmd", et);
        tt.bind("input.cmd", ut);
        (function() {
            if (is_mobile) {
    ...
    function process_command(e, t) {
        ...
        if (n.length) {
            ...
            var u = $.map(n, function(e) {
                var t = e.match(/^(['"]).*\1$/);
                return t && t[1] || ""
            });
            var a = e.slice(r.length).trim();
            return {
                command: e,
                name: r,
                args: i,
    ...
    $.terminal = {
        ...
        iterate_formatting: function e(t, n) {
            ...
            var p = $.terminal.have_formatting(t);
            var m = "";
            var d = false;
            var h = 0;
            var v;
        ...
        nested_formatting: function e(t) {
            ...
            function s(e) {
                ...
                var o = t[0].filter(function(e) {
                    return e[0] === "-"
                }).map(function(e) {
                    return e[1]
                });
                t[0] = t[0].filter(function(e) {
                    return o.indexOf(e) === -1 && o.indexOf(e[1]) === -1
                }).join("");
                return t.join(";")
            }
        ...
        format: function i(e, t) {
            ...
            function r(e) {
                if (e.length && d.allowedAttributes.length) {
                    return e.filter(function(e) {
                        if (e === "data-text") {
                            return false
                        }
                        var t = false;
                        var n = d.allowedAttributes;
            ...
            var _ = u(function(e) {
                return e.match(/^((https?|ftp):\/\/|\.{0,2}\/)/) || n(e)
            });
            var C = u(function(e) {
                return e.match(/^(https?:|blob:|data:)/) || n(e)
            });
            ...
            function i(e, t, n, r, i, u, a) {
                ...
                if ($.terminal.valid_color(n)) {
                    f += ["color:" + n, "--color:" + n, "--original-color:" + n].join(";") + ";";
                    if (t.indexOf("!") !== -1) {
                        f += "--link-color:" + n + ";"
                    }
                    if (t.indexOf("g") !== -1) {
                ...
                if ($.terminal.valid_color(r)) {
                    f += ["background-color:" + r, "--background:" + r].join(";") + ";"
                }
                var D = h(u, a);
                var p = extra_css(a, d);
                if (p) {
                    a = wide_characters(a, d);
                    f += p
                }
                var m;
                if (t.indexOf("!") !== -1) {
                ...
                if (t.indexOf("!") !== -1) {
                    ...
                    m += ' data-text="' + D.replace(/"/g, "&quot;") + '">' + "<span>" + a + "</span></span>"
                }
                return m
            }
            if (typeof e === "string") {
    ...
    $.fn.terminal = function(e, t) {
        ...
        function f(e) {
            ...
            } else if (is_function(ke.processArguments)) {
                return process_command(e, ke.processArguments)
            } else if (ke.processArguments) {
        ...
        function a(e, t) {
            if (is_function(ke.renderHandler)) {
                var n = ke.renderHandler.call(ne, e, t, ne);
                if (n === false) {
                    return false
                }
        ...
        function c(e) {
            if (is_function(ke.onRPCError)) {
                ke.onRPCError.call(ne, e)
            } else {
            ...
            var i = function(e, t) {
                ...
                $.jrpc({
                    ...
                    success: function e(t) {
                        if (t.error) {
                            c(t.error)
                        } else if (is_function(ke.processRPCResponse)) {
                            ke.processRPCResponse.call(ne, t.result, ne)
                        } else {
                            D(t.result)
                        }
                        ne.resume()
        ...
        function d(a, o, s, l) {
            return function(e, t) {
                ...
                if (i === "function") {
                    ...
                    l(e, ne)
                } else if (is_function(ke.onCommandNotFound)) {
                    ke.onCommandNotFound.call(ne, e, ne)
                } else {
        ...
        function h(e, t, n) {
            ne.resume();
            if (is_function(ke.onAjaxError)) {
                ke.onAjaxError.call(ne, e, t, n)
            } else if (t !== "abort") {
        ...
        function v(u, o, r) {
            function s(e) {
                if (e.error) {
                    ...
                    ke.processRPCResponse.call(ne, e.result, ne)
                } else {
                    D(e.result)
                }
                ne.resume()
            ...
            function e(e) {
                var n = e;
                if (ke.describe !== false && ke.describe !== "") {
                    ke.describe.split(".").forEach(function(e) {
                        n = n[e]
                    })
                }
                if (n && n.length) {
                    ...
                    $.each(n, function(e, i) {
                        if ($.isPlainObject(i) && typeof i.name === "string") {
                            t[i.name] = function() {
                                ...
                                if (ke.checkArity && i.params && i.params.length !== n) {
        ...
        function l(t, a, n) {
            ...
            if (e === "array") {
                ...
                (function t(e, n) {
                    ...
                    n({
                        interpreter: d(o, false, a, l && l.bind(ne)),
                ...
                if (ke.describe === false) {
                    ...
                    if ($.isArray(ke.completion)) {
                        o.completion = ke.completion
                    }
                    n(o)
                } else {
                    ne.pause(ke.softPause);
                ...
                n({
                    interpreter: d(t, ke.checkArity, a),
        ...
        function _(e, t, n) {
            if (is_function(ke.exceptionHandler)) {
                ke.exceptionHandler.call(ne, e, t)
            } else {
                ne.exception(e, t);
                if (!n) {
                    setTimeout(function() {
        ...
        function F(e, t, n) {
            ...
            C.push(y);
            var u = {
                linksNoReferrer: ke.linksNoReferrer,
                linksNoFollow: ke.linksNoFollow,
                anyLinks: ke.anyLinks,
                char_width: Ae.width,
                escape: false,
        ...
        function E(e, t) {
            return (strlen(text(e)) > t.cols || e.match(/\n/)) && (ke.wrap === true && t.wrap === undefined || ke.wrap === false && t.wrap === true)
        }
        var x;
        if ("Map" in root) {
            x = new Map
            ...
            try {
                ...
                if (e !== "") {
                    if (!n.raw) {
                        if (n.formatters) {
                            try {
                                e = $.terminal.apply_formatters(e, $.extend(ke, {
                                    echo: true
                                }))
                            } catch (e) {
                                _(e, "FORMATTING")
                        ...
                        var u;
                        var a = n.cols = ne.cols();
                        if (E(e, n)) {
                            var o = n.keepWords;
                            u = $.terminal.split_equal(e, a, o)
                        } else if (e.match(/\n/)) {
                            u = e.split(/\n/)
                        }
                    }
                ...
                C = [];
                if (is_function(ke.exceptionHandler)) {
                    ke.exceptionHandler.call(ne, e, "TERMINAL")
                } else {
        ...
        function A(e) {
            ...
            try {
                ...
                if (is_function(ke.exceptionHandler)) {
                    ke.exceptionHandler.call(ne, e, "TERMINAL (redraw)")
                } else {
        ...
        function T() {
            if (ke.greetings === undefined) {
                ne.echo(ne.signature, {
                    finalize: a11y_hide,
                    formatters: false
                })
            } else if (ke.greetings) {
                var e = typeof ke.greetings;
                if (e === "string") {
                    ne.echo(ke.greetings)
                } else if (e === "function") {
                    try {
                        var t = ke.greetings.call(ne, ne.echo);
                        var n = L("Greetings");
        ...
        function R() {
            return qe.outerWidth() !== ne.outerWidth()
        }
        ...
        function I(n, e, t) {
            function r() {
                if (ke.historyState || ke.execHash && t) {
            ...
            function a() {
                var e = o.interpreter.call(ne, n, ne);
                if (e) {
                    if (!De) {
                        ne.pause(ke.softPause)
                    }
                    ...
                    if (is_function(e.done || e.then)) {
                        return unpromise(e, u, t)
                    } else {
                        return $.when(e).done(u).catch(t)
                    }
                } else if (Oe) {
                    z.push(function() {
                        i()
            ...
            try {
                if (W("onBeforeCommand", [n]) === false) {
                    return
                }
                if (t) {
                    se = n.trim()
                } else {
                    oe = $.terminal.split_command(n)
                }
                if (!Y()) {
                    if (t && (is_function(ke.historyFilter) && ke.historyFilter(n) || n.match(ke.historyFilter))) {
                        Ie.history().append(n)
                    }
                }
                var o = ze.top();
                ...
                if (n.match(/^\s*login\s*$/) && ne.token(true)) {
                    ...
                    i()
                } else if (ke.exit && n.match(/^\s*exit\s*$/) && !Fe) {
                    var f = ne.level();
                    ...
                    i()
                } else if (ke.clear && n.match(/^\s*clear\s*$/) && !Fe) {
                    ne.clear();
                    i()
                } else {
                    var c = a();
        ...
        function N() {
            if (W("onBeforeLogout", [], true) === false) {
                return
            }
            M();
            W("onAfterlogout", [], true);
            ne.login(Ye, true, Q)
        }
        ...
        function U(e) {
            ...
            if ($.isPlainObject(t.keymap)) {
                Ie.keymap(null).keymap($.extend({}, tt, $.omap(t.keymap, function(e, t) {
                    return function() {
        ...
        function W(t, e, n) {
            ...
            } else if (is_function(ke[t])) {
                try {
                    return ke[t].apply(ne, e)
                } catch (e) {
                    ke[t] = null;
                    _(e, t)
                }
        ...
        function K() {
            ...
            return e.is_fully_in_viewport(ne).then(q)
        }

        function J() {
            if (fire_hash_change && ke.execHash) {
                try {
                    if (location.hash) {
        ...
        function Q() {
            ...
            var e = false;
            if (is_function(ke.onInit)) {
                we = function() {
                    e = true
                };
                try {
                    ke.onInit.call(ne, ne)
                } catch (e) {
                    _(e, "OnInit")
                } finally {
                    we = $.noop;
        ...
        function G(e) {
            ...
            } else if (is_function(ke.keydown)) {
                t = ke.keydown.call(ne, e, ne);
                if (t !== undefined) {
                    return t
                }
            }
        ...
        var V = {
            ...
            TAB: function(e, t) {
                ...
                if (typeof n.caseSensitiveAutocomplete !== "undefined") {
                    ...
                    i = ke.caseSensitiveAutocomplete
                }
                if (ke.completion && get_type(ke.completion) !== "boolean" && n.completion === undefined) {
                    r = ke.completion
                } else {
                    r = n.completion
                }
                ...
                function u(e) {
                    ...
                    if (!ne.before_cursor(false).match(/\s/)) {
                        if (ke.clear && $.inArray("clear", e) === -1) {
                            e.push("clear")
                        }
                        if (ke.exit && $.inArray("exit", e) === -1) {
                            e.push("exit")
                        }
                    }
                    ne.complete(e, {
                        echo: true,
                        word: ke.wordAutocomplete,
                        escape: ke.completionEscape,
                        caseSensitive: i,
                        echoCommand: ke.doubleTabEchoCommand,
                        doubleTab: ke.doubleTab
                    })
                }
                if (r) {
                    switch (get_type(r)) {
                        case "function":
                            var a = ne.before_cursor(ke.wordAutocomplete);
                            if (r.length === 3) {
                                var o = new Error(te().comletionParameters);
                                _(o, "USER");
                                return false
                            }
                            var s = r.call(ne, a, u);
                            unpromise(s, u, L("Completion"));
                            break;
                        case "array":
                            u(r);
                            break;
                            ...
                            for (n = requests.length; n--;) {
                                ...
                                if (r.readyState !== 4) {
                                    try {
                                        ...
                                        if (is_function(ke.exceptionHandler)) {
                                            ke.exceptionHandler.call(ne, t, "AJAX ABORT")
                                        } else {
        ...
        function Z(e) {
            var t = ze.top();
            if (je && (!Oe || !ke.pauseEvents)) {
                if (is_function(t.keypress)) {
                    return t.keypress.call(ne, e, ne)
                } else if (is_function(ke.keypress)) {
                    return ke.keypress.call(ne, e, ne)
                }
            }
        }
        ...
        function te() {
            return $.extend({}, $.terminal.defaults.strings, ke && ke.strings || {})
        }
        var ne = this;
        if (this.length > 1) {
            return this.each(function() {
        ...
        var re;
        if (ne.is("body,html")) {
            if (ne.hasClass("full-screen-terminal")) {
                var ie = ne.find("> .terminal").data("terminal");
                if (ie) {
                    return ie
                }
            }
        ...
        $.extend(ne, $.omap({
            ...
            export_view: function() {
                ...
                return $.extend({}, {
                    ...
                    lines: clone(Se),
                    interpreters: ze.clone(),
                    history: Ie.history().data
                }, e)
            },
            import_view: function(t) {
                ...
                _e(function e() {
                    ...
                    Se = clone(t.lines).filter(function(e) {
                        return e[0]
                    });
            ...
            save_state: function(e, t, n) {
                if (typeof n !== "undefined") {
                    save_state[n] = ne.export_view()
                } else {
                    save_state.push(ne.export_view())
                }
                if (!$.isArray(hash_commands)) {
                    hash_commands = []
                }
                if (e !== undefined && !t) {
                    var r = [ce, save_state.length - 1, e];
            ...
            login: function(r, i, u, a) {
                ...
                ne.on("terminal.autologin", function(e, t, n, r) {
                    if (W("onBeforeLogin", [t, n]) === false) {
                        return
                    }
                    s(t, n, r)
                });
                ne.push(function(n) {
                    ne.set_mask(ke.maskChar).push(function(e) {
                        try {
                            if (W("onBeforeLogin", [n, e]) === false) {
                                o();
                                return
                            }
                            ne.pause();
            ...
            complete: function(r, i) {
                ...
                var a = ne.before_cursor(i.word).replace(/\\"/g, '"');
                var s = false;
                if (i.word) {
                    if (a.match(/^"/)) {
                        s = '"'
                    ...
                    if (++le >= 2) {
                        ...
                        if (i.echo) {
                            if (is_function(i.doubleTab)) {
                                ...
                                var p = i.doubleTab.call(ne, a, c, S);
                                ...
                                ne.echo($.terminal.escape_brackets(m), {
                                    keepWords: true,
                                    formatters: false
                                })
                            }
            ...
            pause: function(t) {
                Ce(function e() {
                    we();
                    Oe = true;
                    Ie.disable(t || is_android);
                    if (!t) {
                        Ie.find(".cmd-prompt").hidden()
                    }
                    W("onPause")
                });
                return ne
            ...
            resume: function(i) {
                Ce(function e() {
                    Oe = false;
                    if (je && terminals.front() === ne) {
                        Ie.enable(i)
                    }
                    Ie.find(".cmd-prompt").visible();
                    var t = $e;
                    $e = [];
                    for (var n = 0; n < t.length; ++n) {
            ...
            cols: function() {
                ...
                if (typeof pe === "undefined" || pe === 1e3) {
                    pe = get_num_chars(ne, Ae)
                }
                return pe
            },
            rows: function() {
            ...
            get_prompt: function() {
                return ze.top().prompt
            },
            set_mask: function(t) {
                _e(function e() {
                    Ie.mask(t === true ? ke.maskChar : t)
                });
                return ne
            },
            ...
            resize: function(e, t) {
                if (!ne.is(":visible")) {
                    ...
                    e = ne.width();
                    t = ne.height();
                    if (typeof ke.numChars !== "undefined" || typeof ke.numRows !== "undefined") {
                        Ie.resize(ke.numChars);
                        ne.refresh();
                        W("onResize");
                        return
                    }
                    var n = get_num_chars(ne, Ae);
                    var r = get_num_rows(ne, Ae);
                    if (n !== pe || r !== me) {
                        pe = n;
                        me = r;
                        Ie.resize(pe);
            ...
            refresh: function() {
                if (Ae.width !== 0) {
                    ne[0].style.setProperty("--char-width", Ae.width)
                }
                A({
                    scroll: false,
                    update: true
            ...
            flush: function(e) {
                ...
                try {
                    ...
                    fe.css("visibilty", "");
                    W("onFlush");
                    var s = ne.find(".cmd").offset();
                    var l = ne.offset();
                    setTimeout(function() {
                        css(ne[0], {
                            "--terminal-height": ne.height(),
                            "--terminal-x": s.left - l.left,
                            "--terminal-y": s.top - l.top,
                            "--terminal-scroll": ne.prop("scrollTop")
                        })
                    }, 0);
                    if (ke.scrollOnEcho && e.scroll || t) {
                        ne.scroll_to_bottom()
                    }
                } catch (e) {
                    if (is_function(ke.exceptionHandler)) {
                        try {
                            ke.exceptionHandler.call(ne, e, "TERMINAL (Flush)")
                        } catch (e) {
                            ke.exceptionHandler = $.noop;
            ...
            update: function(r, t, i) {
                _e(function e() {
                    ...
                    if (!Se[r]) {
                        ne.error("Invalid line number " + r)
                    } else if (t === null) {
                        Se.splice(r, 1);
                        fe.find("[data-index=" + r + "]").remove()
                    } else {
                        t = a(t, {
                            update: true,
                            line: r
                ...
                function t(r) {
                    try {
                        var i = $.extend({
                            ...
                            unmount: $.noop,
                            keepWords: false,
                            invokeMethods: ke.invokeMethods,
                            onClear: null,
                            formatters: true,
                            allowedAttributes: ke.allowedAttributes
                        }, n || {});
                        (function(t) {
                            i.finalize = function(e) {
                                if (i.raw) {
                                    e.addClass("raw")
                                }
                                try {
                        ...
                        if (is_function(ke.exceptionHandler)) {
                            ke.exceptionHandler.call(ne, e, "TERMINAL (echo)")
                        } else {
            ...
            token: function(e) {
                return Re.get(ne.prefix_name(e) + "_token")
            },
            ...
            login_name: function(e) {
                return Re.get(ne.prefix_name(e) + "_login")
            },
            name: function() {
                return ze.top().name
            },
            prefix_name: function(e) {
                var t = (ke.name ? ke.name + "_" : "") + ce;
                if (e && ze.size() > 1) {
                    var n = ze.map(function(e) {
                        return e.name || ""
                    }).slice(1).join("_");
                    if (n) {
                        t += "_" + n
            ...
            push: function(a, o) {
                Ce(function e() {
                    ...
                    l(a, o.login, function(e) {
                        ze.push($.extend({}, e, r));
                        if (r.completion === true) {
                            if ($.isArray(e.completion)) {
                                ze.top().completion = e.completion
                            } else if (!e.completion) {
                                ze.top().completion = false
                            }
                        }
                        if (r.login) {
                            var t;
                            ...
                            if (n === "function") {
                                ...
                                ne.login(r.login, r.infiniteLogin, u, t)
                            } else if (get_type(a) === "string" && n === "string" || n === "boolean") {
                                t = r.infiniteLogin ? $.noop : ne.pop;
                                ne.login(g(a, r.login), r.infiniteLogin, u, t)
                            }
                        } else {
                            u()
                        }
            ...
            keymap: function(e, n) {
                ...
                if (typeof n === "undefined") {
                    if (typeof e === "string") {
                        ...
                        e = $.extend({}, tt, $.omap(e || {}, function(n, r) {
                            if (!tt[n]) {
                                return r.bind(ne)
                            }
                            return function(e, t) {
                        ...
                        Ie.keymap(null).keymap(e)
                    }
                } else if (typeof n === "function") {
                    var r = e;
                    if (!tt[r]) {
                        Ie.keymap(r, n.bind(ne))
                    } else {
                        Ie.keymap(r, function(e, t) {
            ...
            purge: function() {
                _e(function e() {
                    ...
                    var n = Re.get(t + "interpreters");
                    if (n) {
                        $.each(JSON.parse(n), function(e, t) {
                            Re.remove(t + "_commands");
                            Re.remove(t + "_token");
                            Re.remove(t + "_login")
                        })
                    }
                    Ie.purge();
                    Re.remove(t + "interpreters")
                });
                return ne
            },
            destroy: function() {
                _e(function e() {
                    ...
                    if (is_mobile) {
                        ne.off(["touchstart.terminal", "touchmove.terminal", "touchend.terminal"].join(" "))
                    }
                    fe.remove();
                    Ue.remove();
                    if (re) {
            ...
            is_bottom: function() {
                if (ke.scrollBottomOffset === -1) {
                    return false
                } else if (typeof ye === "boolean") {
                    return ye
                } else {
                    var e, t, n;
                    e = ne[0].scrollHeight;
        ...
        if (ne.length === 0) {
            var ue = sprintf(te().invalidSelector);
        ...
        var le = 0;
        var fe;
        var ce = terminals.length();
        var De = false;
        var pe;
        var me;
        var de;
        var he = new Stack;
        var ve = new DelayQueue;
        ...
        var Ee, xe;
        var $e = [];
        var ke = $.extend({}, $.terminal.defaults, {
            name: ne.selector,
            exit: !!(t && t.login || !t)
        }, t || {});
        if (typeof ke.width === "number") {
            ne.width(ke.width)
        }
        if (typeof ke.height === "number") {
            ne.height(ke.height)
        }
        var Ae = get_char_size(ne);
        var Be = !terminal_ready(ne);
        delete ke.formatters;
        var Te = false;
        var Se = [];
        var Re = new n(ke.memory);
        var je = ke.enabled;
        var Le = false;
        var Oe = false;
        var Pe = true;
        ...
        var Me;
        var He;
        if (ke.ignoreSystemDescribe === true) {
            ke.describe = false
        }
        $(document).bind("ajaxSend.terminal_" + ne.id(), function(e, t) {
            requests.push(t)
        });
        var Ue = $('<div class="terminal-wrapper"/>').appendTo(ne);
        $(broken_image).hide().appendTo(Ue);
        var We = $('<div class="terminal-font">&nbsp;</div>').appendTo(ne);
        var qe = $('<div class="terminal-fill"/>').appendTo(ne);
        fe = $("<div>").addClass("terminal-output").attr("role", "log").appendTo(Ue);
        ne.addClass("terminal");
        if (ke.login && W("onBeforeLogin") === false) {
            Pe = false
        }
        var Ke;
        if (typeof e === "string") {
            ...
            for (var Je = 0, Qe = e.length; Je < Qe; ++Je) {
                if (typeof e[Je] === "string") {
                    Ke = e[Je];
                    break
                }
            }
        ...
        var Ye;
        if (is_function(ke.login)) {
            Ye = ke.login
        } else if (Ke && (typeof ke.login === "string" || ke.login === true)) {
            Ye = g(Ke, ke.login)
        }
        terminals.append(ne);
        ...
        function Xe(e) {
            ...
            if (get_type(e) !== "string") {
                if (is_function(ke.parseObject)) {
                    var t = ke.parseObject(e);
                    if (get_type(t) === "string") {
                        e = t
                    }
                } else if (is_array(e)) {
                    e = $.terminal.columns(e, ne.cols(), ke.tabs)
                } else {
                    e = String(e)
                }
            }
        ...
        $(document).on("paste.terminal_" + ne.id(), et);
        var tt = $.extend({}, V, $.omap(ke.keymap || {}, function(n, r) {
            if (!V[n]) {
                return r.bind(ne)
            }
            return function(e, t) {
        ...
        l(e, ke.login, function(e) {
            if (ke.completion && typeof ke.completion !== "boolean" || !ke.completion) {
            ...
            ze = new Stack($.extend({}, ke.extra, {
                name: ke.name,
                prompt: t,
                keypress: ke.keypress,
                keydown: ke.keydown,
                resize: ke.onResize,
                greetings: ke.greetings,
                mousewheel: ke.mousewheel,
                history: ke.history,
                keymap: tt
            }, e));
            Ie = $("<div/>").appendTo(Ue).cmd({
                tabindex: ke.tabindex,
                mobileDelete: ke.mobileDelete,
                mobileIngoreAutoSpace: ke.mobileIngoreAutoSpace,
                prompt: Ye ? false : t,
                history: ke.memory ? "memory" : ke.history,
                historyFilter: ke.historyFilter,
                historySize: ke.historySize,
                caseSensitiveSearch: ke.caseSensitiveSearch,
                onPaste: ke.onPaste,
                width: "100%",
                enabled: false,
                char_width: Ae.width,
                keydown: X,
                keymap: tt,
                clickTimeout: ke.clickTimeout,
                holdTimeout: ke.holdTimeout,
                holdRepeatTimeout: ke.holdRepeatTimeout,
                repeatTimeoutKeys: ke.repeatTimeoutKeys,
                allowedAttributes: ke.allowedAttributes,
                keypress: Z,
                tabs: ke.tabs,
            ...
            if (is_mobile) {
                (function() {
                    ...
                    ne.on("touchstart.terminal", function(e) {
                        e = e.originalEvent;
                        window.touch_event = e;
                        if (e.target.tagName.toLowerCase() === "a") {
                            return
                        }
                        if (!Le && e.touches.length === 1) {
                            n = ne.enabled();
                            var t = e.touches[0];
                            i = {
                                x: t.clientX,
                ...
                r.on("focus.terminal_" + ne.id(), Ge).on("blur.terminal_" + ne.id(), Ve);
                (function() {
                    var t = 0;
                    var n;
                    var r = "click_" + ne.id();
                ...
                (function() {
                    ...
                    ne.on(e, function(e) {
                        if (get_selected_html() === "" && d(e)) {
                            ...
                            var n = Ie.offset();
                            var r = Ie[0].getBoundingClientRect();
                            var i = ne.offset();
                            var u = i.top - n.top;
                            ...
                            var s = 4 * 14;
                            var l = 5 * 14;
                            var f = ne[0].getBoundingClientRect();
                            var c = qe.outerWidth();
                            var D = a + r.top + s;
                            D = D - f.height - f.top;
                            var p = o + r.left + l;
                ...
                ne.on("scroll", function() {
                    var e = ne.find("textarea");
                    var t = ne[0].getBoundingClientRect();
                    var n = ne[0].scrollHeight;
                    var r = ne.scrollTop();
                    var i = n - (r + t.height);
                    if (i === 0) {
                        e.css("top", "")
            ...
            function i() {
                ...
                Ae = get_char_size(ne);
                if (e !== Ae.width) {
                    Ie.option("char_width", Ae.width).refresh()
                }
            }
            u();
            ...
            function a() {
                ...
                We.resizer("unbind").resizer(function() {
                    i();
                    ne.resize()
                }, e)
            }
            ...
            function s() {
                if (window.IntersectionObserver) {
                    ...
                    if (ke.scrollBottomOffset !== -1) {
                        t = $("<div/>").css({
                            height: ke.scrollBottomOffset
                        }).appendTo(e)
                    }
                    be = new IntersectionObserver(o, {
                        root: ne[0]
                    });
                    be.observe(t[0])
                }
            ...
            function l() {
                ...
                if (window.IntersectionObserver && ne.css("position") !== "fixed") {
                    Me = new IntersectionObserver(n, {
                        root: null
                    });
                    Me.observe(ne[0])
                } else {
                    Me = setInterval(n, 100)
                }
            }
            ...
            if (ke.execHash) {
                ...
                function n(e, t) {
                    if (!i) {
                        ...
                        } else if (is_function(ke.mousewheel)) {
                            r = ke.mousewheel(e, t, ne)
                        }
                        if (r === true) {
                            return
                        }
                        if ((R() || r === false) && !e.ctrlKey) {
                            e.stopPropagation();
                            e.preventDefault()
                        }
                        if (r === false) {
                ...
                ne.touch_scroll(function(e) {
                    var t = e.current.clientY - e.previous.clientY;
                    var n;
                    var r = ze.top();
                    if (is_function(r.touchscroll)) {
                        n = r.touchscroll(e, t, ne)
                    } else if (is_function(ke.touchscroll)) {
                        n = ke.touchscroll(e, t, ne)
                    }
                    css(ne[0], {
                        "--terminal-scroll": ne.prop("scrollTop")
                    });
